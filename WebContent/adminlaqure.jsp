...
.end-form form {
    display: inline; /* Ensure the form aligns with the button */
}
...
String qry="select * from ethuylamount where client_id='"+id+"' and reportid='"+idr+"'";
...
<section class="error-page">
        ...
        <div class="wrapper">
            <div class="main-cover w3">
                <div class="section-header">
                    <h1>ETHUYL ALCOHOL - FINAL REPORT</h1>
                </div>
   ...
   <div class="end-form">
    ...
    <form action="AcceptLacqure" method="post" style="display:inline;">
        <input type="hidden" name="id" value="<%= id %>">
        <input type="hidden" name="reportid" value="<%= idr %>">
