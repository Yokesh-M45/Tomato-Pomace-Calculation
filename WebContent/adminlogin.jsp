...
<html lang="en">
   ...
   <script>
   var togglePassword = function(fieldId, iconId) {
   ...
   <body>
      ...
      <div class="art-bothside">
         <div class="sap_tabs">
            <div id="horizontalTab">
               <ul class="resp-tabs-list" style="display: flex; justify-content: center;">
               ...
               <div class="resp-tabs-container">
                  <div class="tab-1 resp-tab-content">
                     <div class="swm-right-w3ls">
                        <form action="AdminLogin" method="post"> <!-- Replace action with your servlet URL -->
                           <div class="main">
                              <div class="icon-head-wthree">
                                 <h2>Login Here</h2>
                              </div>
                              <div class="form-left-w3l">
                                 <input type="admin" name="adminemail" placeholder="Email"  autocomplete="off" required="" style="width: 100%;
    color: #000000;
    outline: none;
    font-size: 14px;
    padding: .8em .7em;
    ...
    box-sizing: border-box;">
                              ...
                              <div class="password-container">
                                  <input type="password" id="logpassword" autocomplete="off" name="adminpassword" class="Password" placeholder="Password" required="" style="width: 100%;
    color: #000000;
    outline: none;
    font-size: 14px;
    padding: .8em .7em;
   ...
   <button type="submit" style="width: 100%; box-sizing: border-box;">LogIn</button><br>
</div>
