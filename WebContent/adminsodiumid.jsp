...
String h = (String) s.getAttribute("id");
Connection con=Dbconn.getConectionn();
String qry="select distinct client_id,reportid from sodiumresult where client_id='"+h+"'";
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%= rs.getString(2) %></td>
                                 <td>
    <a href="adminsodiumview.jsp?id=<%= rs.getString(1) %>&repid=<%= rs.getString(2) %>" class="view-report-button">View Details</a>
</td>
