...
<section class="error-page">
    ...
    <a href="adminhome.html" class="back-button" role="button">Back to Home</a>
    <a href="adsafeview.jsp?id=<%= id %>&reportid=<%= rep %>" class="view-safety-button" role="button">View Safety Report</a>
</div>
