...
String qry="select * from migration_result where client_id='"+id+"' and reportid='"+rep+"'";
...
<section class="error-page">
    ...
    <h1>CALCULATED SAFETY REPORT</h1>
</div>
                ...
                <div style="text-align: center; margin-top: 20px;">
                    ...
                    <a href="adminhome.html" class="btn btn-primary back-button" role="button">Back to Home</a>
                     <form action="AcceptSafety" method="post" style="display: inline-block;">
                        <input type="hidden" name="id" value="<%= id %>">
                        <input type="hidden" name="reportId" value="<%= rep %>">
