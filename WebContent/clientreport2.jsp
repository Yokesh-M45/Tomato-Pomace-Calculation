...
String qry = "SELECT DISTINCT client_id, reportid FROM wasteprocessresult WHERE client_id = ?";
        ...
        <div class="wrapper">
            <div class="main-cover w3">
                <div class="section-header">
                    <h1>CALCULATED WASTE REPORT VIEW</h1>
                </div>
            ...
            <th style="background-color: #007bff; color: #fff; padding: 12px 16px; text-align: center; border-bottom: 1px solid #ddd; font-size: 14px;">ACTION</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="wastereportview.jsp?id=<%= rs.getString("client_id") %>&reportid=<%= rs.getString("reportid") %>" class="view-report-button">View Report</a>
                                </td>
                            </tr>
                            <% } %>
                        </tbody>
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <a href="wastehome.html" class="back-button">Back to Home</a>
                </div>
            </div>
        </div>
    </div>
