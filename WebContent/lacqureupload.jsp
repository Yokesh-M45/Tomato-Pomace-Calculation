...
<h1>ETHUYL ALCOHOL RATIO - UPLOAD</h1>

<div class="upload">
    <div class="login-form">
        <form id="FormationUpload" method="post" action="FormationUpload" enctype="multipart/form-data">
            <div id="drop">
                <a>Upload File</a>
            ...
            <div class="button">
    <div class="cancel"><a href="lacqure.html" type="button">Cancel</a></div>
