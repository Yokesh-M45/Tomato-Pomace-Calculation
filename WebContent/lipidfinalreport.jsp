        ...
        <div class="wrapper">
            <div class="main-cover w3">
                <div class="section-header">
                    <h1>SODIUM MIXED RESULT - FINAL</h1>
                </div>
                ...
                <div class="inline-buttons" style="margin-top: 20px;">
    <a href="sodiumh.html" class="btn btn-primary back-button" role="button">Back to Home</a>
    <a href="fpreport.jsp?id=<%= id %>" class="btn btn-primary back-button" role="button">Lipid Report</a>
</div>
