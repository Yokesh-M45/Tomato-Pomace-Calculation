...
String qry="select distinct reportid from sodiumresult";
...
<section class="error-page">
    ...
    <h1>PROCESSED SODIUM HYDROXIDE REPORT</h1>
</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><%= rs.getString(1) %></td>
                                 <td><a href="sodiumresult.jsp?id=<%= rs.getString(1) %>" class="back-button">View Details</a></td>
                            </tr>
                            <% } %>
                        </tbody>
                    </table>
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <a href="wastehome.html" class="btn btn-primary back-button" role="button">Back to Home</a>
                </div>
            </div>
        </div>
    </div>
