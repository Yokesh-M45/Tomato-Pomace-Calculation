...
<html lang="en">
<head>
    <title>Lipid Extraction Login And Register</title>
...
<body>
    <h1 class="header-w3ls">LIPID EXTRACTION LOGIN AND REGISTER</h1>
                ...
                <div class="resp-tabs-container">
                    ...
                    <div class="tab-1 resp-tab-content">
                        <div class="swm-right-w3ls">
                            <form action="UserLogin" method="post"> <!-- Adjust the servlet URL as needed -->
                                <div class="main">
    ...
    box-sizing: border-box;" required="">
                    ...
                    <div class="tab-1 resp-tab-content">
                        <div class="swm-left-w3ls">
                            <form action="LipidRegister" method="post"> <!-- Adjust the servlet URL as needed -->
                                <div class="main">
                                    <div class="icon-head-wthree">
                                        <h2>Register Here</h2>
                                    </div>
                                    <div class="form-left-to-w3l">
                                        <input type="text" name="lipname" autocomplete="off" placeholder="Name" required="">
                                    </div>
                                    <div class="form-left-w3l">
                                        <input type="email" name="lipemail" autocomplete="off" placeholder="Email" required="">
                                    </div>
                                    <div class="form-left-to-w3l">
                                        <input type="text" name="lipnumber" autocomplete="off" placeholder="Mobile Number" required="">
                                    </div>
                                    <div class="form-left-to-w3l">
                                        <input type="text" name="lipid"  autocomplete="off" placeholder="Employee ID" required="">
                                    </div>
                                    <div class="btnn">
    ...
    <script>
        ...
        function redirectToAnotherPage() {
            window.location.href = 'lipidstatuscheck.jsp'; 
        }
