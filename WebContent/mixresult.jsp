...
String qry = "SELECT * FROM ethuylamount WHERE client_id=? AND reportid=?";
        ...
        <div class="wrapper">
            <div class="main-cover w3">
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <a href="lacqure.html" class="btn btn-primary back-button" role="button">Back to Home</a>
                </div>
            </div>
        </div>
    </div>
