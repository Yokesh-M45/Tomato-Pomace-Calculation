...
String qry = "SELECT DISTINCT client_id, reportid FROM migration_result WHERE client_id = ?";
            ...
            <th style="background-color: #007bff; color: #fff; padding: 12px 16px; text-align: center; border-bottom: 1px solid #ddd; font-size: 14px;">ACTION</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="sfview.jsp?id=<%= rs.getString("client_id") %>&reportid=<%= rs.getString("reportid") %>" class="view-report-button">View Report</a>
                                </td>
                            </tr>
                            <% } %>
                        </tbody>
