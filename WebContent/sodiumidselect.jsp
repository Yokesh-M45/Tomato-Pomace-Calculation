...
String qry="select distinct reportid from wasteprocessresult";
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><%= rs.getString(1) %></td>
                                 <td><a href="sodiumprocess.jsp?id=<%= rs.getString(1) %>" class="back-button">View Details</a></td>
                            </tr>
                            <% } %>
                        </tbody>
                    </table>
