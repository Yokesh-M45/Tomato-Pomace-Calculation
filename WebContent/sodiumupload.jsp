...
<h1>SODIUM QUANTITY UPLOAD</h1>

<div class="upload">
    <div class="login-form">
        <form id="uploadForm" method="post" action="SodiumAmount" enctype="multipart/form-data">
            <div id="drop">
                <a>Upload File</a>
            ...
            <div class="button">
    <div class="cancel"><a href="sodiumh.html" type="button">Cancel</a></div>
