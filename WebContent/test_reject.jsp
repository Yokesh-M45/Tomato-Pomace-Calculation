...
String id = request.getParameter("empmail");
...
host ="smtp.gmail.com";
user ="yokeshpm45@gmail.com"; 
pass ="tjypqcjkcsczniko"; 
String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
String to ="yokeshpm45@gmail.com";
String from ="yokeshpm45@gmail.com";
...
String sql="delete from protectivetesting where empemail='"+id+"'";
