...
<h1>PH RATIO UPLOAD</h1>

<div class="upload">
    <div class="login-form">
        <form id="uploadForm" method="post" action="TestUpload" enctype="multipart/form-data">
            <div id="drop">
                <a>Upload File</a>
            ...
            <div class="button">
    <div class="cancel"><a href="test.html" type="button">Cancel</a></div>
