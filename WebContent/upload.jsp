...
.upload-btn:hover {
    background-color: darkgreen !important; /* Or any other color you prefer */
}
...
<h1>ADMIN - REQUIREMENTS UPLOAD</h1>

<div class="upload">
    <div class="login-form">
        <form id="uploadForm" method="post" action="AdminUpload" enctype="multipart/form-data">
            <div id="drop">
                <a>Upload File</a>
            ...
            <div class="button">
    <div class="cancel"><a href="adminhome.html" type="button">Cancel</a></div>
