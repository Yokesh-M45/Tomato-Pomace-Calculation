...
<html lang="en">
   ...
   <body>
      <h1 class="header-w3ls">
        WASTE PROCESS LOGIN AND REGISTER
      </h1>
               ...
               <div class="resp-tabs-container">
                  <div class="tab-1 resp-tab-content">
                     <div class="swm-right-w3ls">
                        <form action="WasteLogin" method="post"> <!-- Replace action with your servlet URL -->
                           <div class="main">
                  ...
                  <div class="tab-1 resp-tab-content">
                     <div class="swm-left-w3ls">
                        <form action="WasteRegister" method="post"> <!-- Replace action with your servlet URL -->
                           <div class="main">
                              <div class="icon-head-wthree">
                                 <h2>Register Here</h2>
                              </div>
                              ...
                              <div class="form-left-to-w3l">
                                 <input type="text" name="number"  autocomplete="off" placeholder="Mobile Number" required="">
                              </div>
                              <div class="form-left-to-w3l">
                                 <input type="text" name="wpid"  autocomplete="off" placeholder="Employee ID" required="">
                              </div>
                              <div class="btnn">
      ...
      <script>
         ...
         function redirectToAnotherPage() {
            window.location.href = 'wastestatuscheck.jsp'; 
         }
      </script>
   </body>
</html>
