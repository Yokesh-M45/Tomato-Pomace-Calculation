...
<style>
    body {
        ...
        background: url("images/waste.jpg");
...
%>
<h1>PERFORM WASTE CALCULATION</h1>
    <div class="form-container">
        <form action="WasteCalculation" method="post">
        <input type="hidden" name="clientId" value="<%= id %>">
            <input type="submit" value="Perform Calculation">
        </form>
        <div style="margin-top: 20px;">
            <a href="clientiswaste.jsp" class="back-button">Back to Home</a>
        </div>
    </div>
</body>
</html>
